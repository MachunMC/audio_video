...
一张1920 * 1080的图片，共有1920 * 1080个像素点。如果采用RGB编码方式，每个像素点用RGB表示，每个颜色占用8 比特，因此每个像素占3字节，那一张1920 * 1080的图片，占用的内存大小为 1920 * 1080 * 3 / 1024 / 1024 = 5.93 MB，占用的空间
